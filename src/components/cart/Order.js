                ...
                <div className="cart__product_cards">
                    {products.map(item => (
                        <article key={item.id} className="cart__product_card">
                            ...
                            <img src={item.imgcart} alt={item.title} className="cart__product_card__img" />
                            <div className="cart__product_card__info">
                                <h3 className="cart__product_card__info__title">{item.title}</h3>
                                <p className="cart__product_card__info__param">
                                    Price: <span className="cart__product_card__info__price">${item.price.toFixed(2)}</span>
                                </p>
                                <p className="cart__product_card__info__param">
                                    Color: <span>Red</span>
                                </p>
