...
import photo from '../../../img/sub_info_img.png';
        ...
        <section className="subscribe">
            <div className="subscribe__content center">
                <div className="subscribe__content-left">
                    <img src={photo} alt="photo" className="subscribe__content-left__img" />
                ...
                <div className="subscribe__content-right">
                    ...
                    <div className="subscribe__content-right__form">
                        <input type="text" className="subscribe__content-right__form-input" placeholder="Enter Your Email" />
                        <button className="subscribe__content-right__form-button">Subscribe</button>
                    </div>
                </div>
            </div>
        </section>
