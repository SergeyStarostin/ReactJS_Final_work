                ...
                <div className="description__filters">
                    <details className="description__filters__item">
                        ...
                        <div className="description__filters__item-show">
                            <form action="#">
                                <label><input type="checkbox" name="color1" id="color1" />Yellow</label>
                                <label><input type="checkbox" name="color2" id="color2" />Pink</label>
                                <label><input type="checkbox" name="color3" id="color3" />Green</label>
                            </form>
                        </div>
                    </details>
                    <details className="description__filters__item">
                        ...
                        <div className="description__filters__item-show">
                            <form action="#">
                                <label><input type="checkbox" name="size1" id="size1" />xs</label>
                                <label><input type="checkbox" name="size2" id="size2" />s</label>
                                <label><input type="checkbox" name="size3" id="size3" />m</label>
                                <label><input type="checkbox" name="size4" id="size4" />l</label>
                            </form>
                        </div>
                    </details>
                    <details className="description__filters__item">
