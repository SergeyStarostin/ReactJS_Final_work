...
const ProductsPagination = ({ productsData, currentPage, pageSize, onPageChange }) => {
    ...
    for (let page = startPage; page <= endPage; page++) {
        pages.push(
            <Link
                ...
                className={`products__pagination__number ${page === currentPage ? 'products__pagination__number-active' : ''}`}
    ...
    return (
        <div className="products__pagination">
            ...
            {currentPage > 1 && (
                ...
                >
                    <svg width="8px" height="14px" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
