...
const ProductsForCatalog = () => {
    ...
    return (
        <section className="products center">
            ...
            <Products productsData={filteredProducts} pageSize={PAGE_SIZE} currentPage={currentPage} />
            <ProductsPagination productsData={filteredProducts} pageSize={PAGE_SIZE} currentPage={currentPage} onPageChange={handlePageChange} />
        </section>
    );
}
